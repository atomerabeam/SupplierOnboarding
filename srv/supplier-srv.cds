using my.visaModels as supplier from '../db/supplier';
...
service Supplier {
    ...
    action updateSupplier(buyerID : String, supplierID : String, oSupplier : supplier.typeSupplier)                         returns String;
    ...
    action submitSupplier(oSupplier : supplier.typeSupplierOnboarding)                                                      returns String;
}
